...
static void getInputAndOutputFromModel(){
    HIAI_ModelTensorInfo* modelTensorInfo = HIAI_ModelManager_getModelTensorInfo(modelManager, model_name.c_str());
...
Java_com_example_isausmanov_scriboai_model_ModelManager_registerListenerJNI(JNIEnv *env, jclass type,
                                                          jobject callbacks) {
...
Java_com_example_isausmanov_scriboai_model_ModelManager_loadModelAsync(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_isausmanov_scriboai_model_ModelManager_runModelAsync(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_isausmanov_scriboai_model_ModelManager_unloadModelAsync(JNIEnv *env, jclass type) {
    if (NULL == modelManager) {
        LOGE("please load model first");
