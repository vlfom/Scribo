package com.example.vlfom.emptymfccapplication.wav_reader;// Wav file IO class
// A.Greensted
...
public class WavFile
{
    ...
    public static WavFile openWavFile(FileInputStream iStream) throws IOException, WavFileException
    {
